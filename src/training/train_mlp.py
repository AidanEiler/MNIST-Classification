...
def train():
    ...
    """
    print("=" * 60)
    print("MNIST Classification - Multilayer Perceptron (MLP)")
    print("=" * 60)
    ...
    viz.plot_confusion_matrix(y_test, predictions, "MLP")
    viz.plot_training_history(history['losses'], history['test_accuracies'], "MLP")

    print("\n" + "=" * 60)
    print("mlp training and testing complete!")
    print("=" * 60)
